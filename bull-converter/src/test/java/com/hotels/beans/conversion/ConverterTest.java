...
public class ConverterTest extends AbstractConversionTest {
    ...
    private Iterator<Object[]> dataConvertValueTesting() {
        List<Object[]> testCases = new ArrayList<>(
                new Object[]{"Tests that the method returns a null value in case the value to convert is null", null, BigInteger.class, null},
                ...
                new Object[]{"Tests that the method returns a BigInteger value from a byte[]", EIGHT_BYTE_BYTE_ARRAY, BigInteger.class, BigInteger.valueOf(wrap(EIGHT_BYTE_BYTE_ARRAY).getLong())},
                ...
                new Object[]{"Tests that the method returns a BigDecimal value from a byte[]", EIGHT_BYTE_BYTE_ARRAY, BigDecimal.class, BigDecimal.valueOf(wrap(EIGHT_BYTE_BYTE_ARRAY).getDouble())});
        Collections.addAll(testCases, dataConvertByteArrayValueTesting());
