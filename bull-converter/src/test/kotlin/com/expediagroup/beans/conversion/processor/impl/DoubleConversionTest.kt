...
/**
 * Unit test for [DoubleConversionProcessor].
 */
class DoubleConversionTest : AbstractConversionTest() {
    /**
     * The class to be tested.
     */
    @InjectMocks
    private val underTest: DoubleConversionProcessor? = null
    ...
    fun testConvertByteShouldReturnProperResult() {
        ...
        // THEN
        Assertions.assertThat(actual).isEqualTo(DOUBLE_VALUE)
    }

    @Test
    fun testConvertByteArrayShouldReturnProperResult() {
        // GIVEN
        val expected = ByteBuffer.wrap(EIGHT_BYTE_BYTE_ARRAY).double
    ...
    /**
     * Tests that the method `convertBoolean` returns the expected double.
     ...
     */
    @DataProvider
    private fun booleanToDoubleConvertValueTesting(): Array<Array<Any>> {
        return arrayOf(
            arrayOf(
            ...
            arrayOf("Tests that the method returns 0 if the value is false", java.lang.Boolean.FALSE, FALSE_AS_DOUBLE)
        )
    }
    ...
    fun testConvertStringShouldReturnProperResult() {
        ...
        // THEN
        Assertions.assertThat(actual).isEqualTo(java.lang.Double.valueOf(STRING_VALUE))
    }
    ...
    companion object {
        private const val TRUE_AS_DOUBLE = 1.0
        private const val FALSE_AS_DOUBLE = 0.0
    }
}
