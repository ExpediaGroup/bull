...
class ConverterTest : AbstractConversionTest() {
     ...
     */
    @InjectMocks
    private val underTest: ConverterImpl? = null
    ...
    private fun dataGetConversionFunctionTesting(): Array<Array<Any?>> {
        return arrayOf(
            arrayOf(
                ...
                BigInteger::class.java, BigDecimal::class.java, BigDecimalConversionProcessor().convertBigInteger()
            ), arrayOf(
                ...
                ByteArray::class.java, String::class.java, StringConversionProcessor().convertByteArray()
            )
        )
    }
    ...
    fun <T> testConvertValueWorksProperly(
        testCaseDescription: String?, valueToConvert: T,
        targetClass: Class<*>?, expectedValue: Any?
    ) {
        // GIVEN
    ...
    private fun dataConvertByteArrayValueTesting(): Array<Array<Any>> {
        return arrayOf(
            ...
            arrayOf(
                "Tests that the method returns a byte[] value from a char", TRUE_AS_CHAR_VALUE, byteArrayOf(
                    TRUE_AS_CHAR_VALUE.code.toByte()
                )
            ),
            arrayOf(
