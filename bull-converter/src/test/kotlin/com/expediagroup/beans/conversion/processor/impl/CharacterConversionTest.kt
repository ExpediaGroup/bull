...
/**
 * Unit test for [CharacterConversionProcessor].
 */
class CharacterConversionTest : AbstractConversionTest() {
    /**
     * The class to be tested.
     */
    @InjectMocks
    private val underTest: CharacterConversionProcessor? = null
    ...
    fun testConvertByteShouldReturnProperResult() {
        ...
        // THEN
        Assertions.assertThat(actual).isEqualTo(Char(BYTE_VALUE.toUShort()))
    }

    @Test
    fun testConvertByteArrayShouldReturnProperResult() {
        // GIVEN
        val expected = ByteBuffer.wrap(EIGHT_BYTE_BYTE_ARRAY).char
    ...
    fun testConvertShortShouldReturnProperResult() {
        ...
        // THEN
        Assertions.assertThat(actual).isEqualTo(Char(SHORT_VALUE.toByte().toUShort()))
    }
    ...
    fun testConvertIntegerShouldReturnProperResult() {
        ...
        // THEN
        Assertions.assertThat(actual).isEqualTo(INTEGER_VALUE.toChar())
    }
    ...
    fun testConvertLongShouldReturnProperResult() {
        ...
        // THEN
        Assertions.assertThat(actual).isEqualTo(Char(LONG_VALUE.toUShort()))
    }
    ...
    fun testConvertFloatShouldReturnProperResult() {
        ...
        // THEN
        Assertions.assertThat(actual).isEqualTo(FLOAT_VALUE.toInt().toChar())
    }
    ...
    fun testConvertDoubleShouldReturnProperResult() {
        ...
        Assertions.assertThat(actual)
            .isEqualTo(DOUBLE_VALUE.toInt().toChar())
    }
    ...
    fun testConvertCharacterShouldReturnProperResult() {
        ...
        // THEN
        Assertions.assertThat(actual).isEqualTo(CHAR_VALUE)
    }

    /**
     * Tests that the method `convertBoolean` returns the expected char.
     ...
     */
    @DataProvider
    private fun booleanToCharConvertValueTesting(): Array<Array<Any>> {
        return arrayOf(
            arrayOf(
            ...
            arrayOf("Tests that the method returns F if the value is false", java.lang.Boolean.FALSE, FALSE_AS_CHAR)
        )
    }
    ...
    fun testConvertStringShouldReturnProperResult() {
        ...
        // THEN
        Assertions.assertThat(actual).isEqualTo(STRING_VALUE[0])
    }

    @Test
    fun testConvertBigIntegerShouldReturnProperResult() {
        // GIVEN
        val expectedValue = BigInteger.ZERO.toInt().toChar()
    ...
    fun testConvertBigDecimalShouldReturnProperResult() {
        // GIVEN
        val expectedValue = BigDecimal.ZERO.toDouble().toInt().toChar()
    ...
    companion object {
        private const val TRUE_AS_CHAR = 'T'
        private const val FALSE_AS_CHAR = 'F'
    }
}
