...
/**
 * Unit test for [FloatConversionProcessor].
 */
class FloatConversionTest : AbstractConversionTest() {
    /**
     * The class to be tested.
     */
    @InjectMocks
    private val underTest: FloatConversionProcessor? = null
    ...
    fun testConvertByteShouldReturnProperResult() {
        ...
        // THEN
        Assertions.assertThat(actual).isEqualTo(FLOAT_VALUE)
    }

    @Test
    fun testConvertByteArrayShouldReturnProperResult() {
        // GIVEN
        val expected = ByteBuffer.wrap(EIGHT_BYTE_BYTE_ARRAY).float
    ...
    /**
     * Tests that the method `convertBoolean` returns the expected float.
     ...
     */
    @DataProvider
    private fun booleanToFloatConvertValueTesting(): Array<Array<Any>> {
        return arrayOf(
            arrayOf(
                "Tests that the method returns 1 if the value is true",
                BOOLEAN_VALUE,
                TRUE_AS_FLOAT
            ), arrayOf("Tests that the method returns 0 if the value is false", java.lang.Boolean.FALSE, FALSE_AS_FLOAT)
        )
    }
    ...
    fun testConvertStringShouldReturnProperResult() {
        ...
        // THEN
        Assertions.assertThat(actual).isEqualTo(java.lang.Float.valueOf(STRING_VALUE))
    }
    ...
    fun testConvertBigIntegerShouldReturnProperResult() {
        ...
        // WHEN
        val actual = underTest!!.convertBigInteger().apply(BigInteger.ZERO).toDouble()
    ...
    companion object {
        private const val TRUE_AS_FLOAT = 1f
        private const val FALSE_AS_FLOAT = 0f
    }
}