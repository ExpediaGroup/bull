 ...
 * Note: this is a copy of `ClassType` in module bull-common,
 ...
 * letting us stub the return value of [ClassUtils.getClassType].
 */
enum class ClassType {
     ...
     * @param classType the [ClassType] to which compare
     * @return true if this is equals to the given class type
     */
    fun `is`(classType: ClassType): Boolean {
