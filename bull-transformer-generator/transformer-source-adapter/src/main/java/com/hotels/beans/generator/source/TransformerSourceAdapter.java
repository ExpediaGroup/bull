...
public class TransformerSourceAdapter {
    ...
    /**
     * The source transformer spec.
     */
    private final SourceTransformerSpec spec;

    /**
     * Creates a {@link TransformerFile} instance for the given class source to the destination.
     * @param source the source class to write
     * @param destination the destination path
     * @param <A> the source class type
     * @param <B> the destination class type
     * @return a {@link TransformerFile} instance
     */
