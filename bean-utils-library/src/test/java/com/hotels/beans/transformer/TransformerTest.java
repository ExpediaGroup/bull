...
public class TransformerTest extends AbstractTransformerTest {
    ...
    private Object[][] dataGetTransformerFunctionTesting() {
        Map<String, FieldTransformer<Object, Object>> ageFieldNameTransformerMap = new HashMap<>();
        ageFieldNameTransformerMap.put(AGE_FIELD_NAME, new FieldTransformer<>(AGE_FIELD_NAME, () -> null));
        return new Object[][] {
            ...
            {"Test that no conversion function is added to the existing one if there is a field transformer function defined for the existing field",
                    AGE_FIELD_NAME, true, true, ageFieldNameTransformerMap, null, ONE.intValue()}
        };
    }
