...
public class ImmutableToSubFoo implements ISubClass {
    ...
    public ImmutableToSubFoo(final String name, final int[] phoneNumbers, final Map<String, String> sampleMap, final Map<String, List<String>> complexMap, final Map<String, Map<String, String>> veryComplexMap) {
        this.name = name;
