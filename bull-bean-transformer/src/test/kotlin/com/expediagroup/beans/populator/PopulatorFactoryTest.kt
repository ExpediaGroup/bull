...
class PopulatorFactoryTest {
     ...
     */
    @InjectMocks
    private lateinit var underTest: PopulatorFactory

    /**
     * Transformer object.
     */
    @Mock
    private lateinit var transformer: BeanTransformer
    ...
    fun testGetPopulatorReturnsTheExpectedResult(type: Class<Any>?, expectedResult: Class<out Populator<*>?>?) {
        // GIVEN

        // WHEN
        val populator = PopulatorFactory.getPopulator(type, type, transformer)
