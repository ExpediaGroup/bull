...
class BeanTransformerTest : AbstractBeanTransformerTest() {
    ...
    fun testRemoveFieldMappingWorksProperly() {
        ...
        // THEN
        Assertions.assertThat<Any, Any>(transformerSettings.fieldsNameMapping).doesNotContainKey(DEST_FIELD_NAME)
    }
    ...
    fun testResetFieldsMappingWorksProperly() {
        ...
        // THEN
        Assertions.assertThat<Any, Any>(transformerSettings.fieldsNameMapping).isEmpty()
    }
    ...
    fun testResetFieldsTransformerWorksProperly() {
        ...
        // THEN
        Assertions.assertThat<Any, Any>(transformerSettings.fieldsTransformers).isEmpty()
    }
    ...
    fun testRemoveFieldTransformerWorksProperly() {
        ...
        // THEN
        Assertions.assertThat<Any, Any>(transformerSettings.fieldsTransformers).doesNotContainKey(DEST_FIELD_NAME)
    }
