...
#### Added
* Configured Travis in order to automatically build the application and build the site. Travis build site available [here](https://travis-ci.org/HotelsDotCom/bull) 
