...
#### Added
* Configured Travis in order to automatically build the application, perform a quality check and publish the site. Travis build site available [here](https://travis-ci
.org/HotelsDotCom/bull) 
